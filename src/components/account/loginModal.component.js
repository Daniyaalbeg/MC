      ...
      <Modal show={show} onHide={handleClose} className="modalFont">
        <Modal.Header closeButton>
          <Modal.Title>
            {auth ? "My Account" : "Log in"}
            {auth &&
              <Link className="linkButtonText" to="/createEvent"><button onClick={handleClose} size="sm" className="createEventButton standardButton smallVersion"> Create Rations </button></Link>
            }
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
