    ...
    <div className="callToActionProgressButtons">
      ...
      {project.volunteeringInfo && (
        <button
          ...
          className="standardButtonWithoutColour mcRedOrange"
        >
          {" "}
          <FontAwesomeIcon
            icon={faHandsHelping}
      ...
      {project.supplies && project.supplies.length !== 0 && (
        <button
          ...
          className="standardButtonWithoutColour mcBlueBG"
        >
          {" "}
      ...
      <CallToActionModal
        ...
        auth={auth}
        funding={showFundingModal}
        volunteer={showVolunteerModal}
        supply={showSupplyModal}
        project={project}
        closeModal={() =>
          closeModal(
            setShowFundingModal,
