...
//Schema Defined
const sponsorRequests = new schema.Entity('sponsorRequests', {}, { idAttribute: "_id"})

const volunteerRequests = new schema.Entity('volunteerRequests', {}, { idAttribute: "_id"})
const volunteeringInfo = new schema.Entity('volunteeringInfo', {
...
const organisations = new schema.Entity('createdOrganisations', {
  projects: [projects],
  sponsorRequests: [sponsorRequests]
}, { idAttribute: "_id"})
...
export const normalizeUserState = (data) => {
  ...
  for (const [key] of Object.entries(normalizedData.entities.createdOrganisations)) {
  ...
  for (const [key] of Object.entries(normalizedData.entities.volunteeringInfo)) {
    normalizedData.entityIds.volunteeringInfo.push(key)
  }
  for (const [key] of Object.entries(normalizedData.entities.volunteerRequests)) {
