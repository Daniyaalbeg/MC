...
export const GET_USER_INFO_BACKGROUND_SUCCESS =
	'GET_USER_INFO_BACKGROUND_SUCCESS';
export const GET_USER_INFO_BACKGROUND_FAILURE =
	'GET_USER_INFO_BACKGROUND_FAILURE';
